...
export const SAFE_CAUSE_CODE_MESSAGES: Record<string, string> = {
  ...
  CONTENT_IMAGE_NOT_VERIFIED: '대표 이미지 자동 정책 검사가 아직 끝나지 않았습니다. 시스템이 다시 검사하며 계속 실패하는 항목만 조치 대상입니다.',
  CONTENT_DISPATCH_FAILED: '콘텐츠 작업을 처리 대기열에 넣지 못했습니다.',
  FAQ_FIELDS_MISSING: 'FAQ 질문과 답변 요약이 완성되지 않아 공개를 보류했습니다. 시스템이 다음 복구 배치에서 다시 생성합니다.',
