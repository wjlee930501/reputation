...
def readiness_next_actions() -> Mapping[str, str]:
    ...
    return {
        "core_profile": (
            "필수 병원 정보가 비어 있으면 온보딩과 콘텐츠 준비가 멈춥니다. 프로파일 탭에서 "
            "주소, 전화, 지역, 진료과목, 키워드, 원장, 진료항목을 입력하고 “저장”을 누르세요."
            + support
        ),
        "local_entity": (
            "지도 정보가 없으면 AI가 병원의 위치를 정확히 이해하기 어렵습니다. 프로파일 탭에서 "
            "Google 병원 정보 또는 지도 URL을 입력하고 “저장”을 누르세요." + support
        ),
        "external_profiles": (
            "공식 채널이 없으면 병원 정보의 근거를 교차 확인하기 어렵습니다. 프로파일 탭에서 "
        ...
        "v0_report": (
            ...
            "“V0 리포트 재실행”을 누르고 완료 결과를 확인하세요." + support
        ),
        "site_built": (
