    ...
    match event.event_type:
        ...
        case OnboardingEventType.HANDOFF_ACCEPTED:
            return MilestoneProjection(
                ...
                "고객 인계 승인",
                "온보딩 작업을 시작할 수 있습니다.",
                "병원 정보에서 아직 등록하지 않은 공식 자료를 보완해 주세요.",
                event.owner_label,
                sla_label,
                f"/hospitals/{event.hospital_id}/info",
                False,
        ...
        case OnboardingEventType.ACTIVATION_READY:
            return MilestoneProjection(
                ...
                event.owner_label,
                sla_label,
                f"/hospitals/{event.hospital_id}/info#domain-setup",
                True,
                False,
            )
        case OnboardingEventType.HOSPITAL_ACTIVE:
            return MilestoneProjection(
                ...
                "추가 조치가 필요하지 않습니다. 정기 작업은 시스템이 진행합니다.",
                event.owner_label,
                sla_label,
                f"/hospitals/{event.hospital_id}",
                False,
                False,
            )
        case unreachable:
