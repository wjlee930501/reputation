...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "- 진단 리포트 이메일 발송: Resend (Plus Five Five, Inc.) — 미국 (수신 이메일, 병원명, 리포트 열람 링크와 이메일 메타데이터)",
      "국외 이전 고지 — Slack 이전 항목: 병원명, 진료과/지역, 마스킹된 연락처 및 운영 알림 메타데이터(환자 질문 본문 제외), 이전 국가: 미국, " +
        ...
        "Resend 이전 항목: 수신 이메일, 병원명, 리포트 열람 링크와 이메일 메타데이터, 이전 국가: 미국, 이전받는 자: Plus Five Five, Inc., 이전 목적: 진단 리포트 이메일 발송. " +
        "보유·이용 기간: 본 방침 제3조의 보유기간 또는 각 수탁사의 계약상 삭제 기간 중 적용되는 기간.",
    ],
  },
  {
    title: "6. 쿠키 및 광고·분석 도구",
    body: [
      "서비스는 방문 경로 분석과 광고 성과 측정을 위해 다음 쿠키를 사용합니다. 모두 퍼스트파티 쿠키이며 환자 개인정보나 진료 정보는 담지 않습니다.",
