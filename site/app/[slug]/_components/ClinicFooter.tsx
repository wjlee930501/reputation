    ...
    <footer className="hub-footer">
      <div className="hub-container">
        <div className="hub-footer-cta">
          ...
          <a href={`tel:${phone}`} className="hub-btn hub-btn--primary">
        ...
        <div className="hub-footer-cols">
          <div className="hub-footer-col">
            <p className="hub-footer-name">{hospitalName}</p>
            {directorName && <p className="hub-footer-meta">대표자 {directorName}</p>}
            {websiteUrl && (
              <p className="hub-footer-meta">
                <a href={websiteUrl} target="_blank" rel="noopener noreferrer">
                  병원 공식 홈페이지
                  <ExternalIcon className="hub-icon hub-icon--sm" style={{ color: 'currentColor', width: 13, height: 13 }} />
                </a>
              </p>
            )}
          </div>
          <div className="hub-footer-col">
            <span className="hub-footer-label">연락처</span>
            <p className="hub-footer-meta">{fullClinicAddress(address, addressDetail)}</p>
            <p className="hub-footer-meta">
