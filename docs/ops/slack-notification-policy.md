...
문서 버전: **2.4** · 갱신일: **2026-09-08 (Asia/Seoul)**
...
`PROVIDER_UNAVAILABLE`, `GENERATION_LEASE_ACTIVE`, `STALE_GENERATION_CLAIM`, 이미지 생성·검증
계열)은 07:45 복구를 넘겨 08:00까지 남은 경우에만 요약에 넣는다. 새 자료가 들어와
