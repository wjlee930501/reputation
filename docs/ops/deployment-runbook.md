...
실제 digest·롤백 좌표·검증 범위는 [통합 안정성 배포 기록](../releases/2026-09-22-integrity-production.md)을 따른다.
...
아래 날짜별 상태는 당시 이력이며 현재 실행 정본은 [통합 운영 배포 기록](../releases/2026-09-17-integrated-production.md)이다.
